...
export const myGame: Game = {
    ...
    gameBackground: "/submissions/minefield-path/background.svg",
    card: "/submissions/minefield-path/card.png",
    banner: "/submissions/minefield-path/banner.png",
    themeColorBackground: "#0ea5e9",
    song: "/minefield-path/audio/song.mp3",
    payouts: {
        1: { 0: { 0: 0.5 } },
        25: { 0: { 0: 6 } },
        50: { 0: { 0: 12 } },
